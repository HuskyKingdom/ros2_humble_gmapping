...
#include "slam_gmapping_altered/slam_gmapping_altered.h"
...
void SlamGmapping::handleMapResetService(
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::Service<std_srvs::srv::Empty>::SharedPtr service = slam_gmapping_node->create_service<std_srvs::srv::Empty>(
    "map_clear_serve", std::bind(&SlamGmapping::handleMapResetService, slam_gmapping_node, std::placeholders::_1,std::placeholders::_2));
